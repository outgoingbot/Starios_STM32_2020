...
#define SSD1306_I2C_ADDR         0x3C << 1 //0x78  -need to shift one left due to 7-Bit vs 8-Bit I2C addresses
#endif
...
/**
 * @brief  Puts string fromm integer to internal RAM //izzle
 ...
 */
void SSD1306_Puti(uint16_t x, uint16_t y, int data, uint16_t length);

void SSD1306_Putf(uint16_t x, uint16_t y, float data, uint16_t length);
